...
class User(Base):
    ...
    userBiography = Column(String(550), default=None)
    userEmail = Column(String(50), default=None)
    userProfileIMGPath = Column(String(255), default=None)
    userBannerIMGPath = Column(String(255), default=None)
